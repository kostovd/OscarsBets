                                ...
                                <div id="title">
                                    <div class="items">                                      
                                       <a href="<%# BuildUrl(Item.Id) %>"><%# Item.Title %> (<%# DisplayYear(Item.ReleaseDate) %>)</a>
                                        <asp:Button ID="MarkAsWatchedButton" runat="server" CssClass="items checkButton" Text= "ü" CommandName="MarkAsWatched" CommandArgument='<%# Item.Id %>' Enabled=<%# DoesUserWatchedThisMovie(Item.UsersWatchedThisMovie)%> />
                                    </div>
                                </div>
